...
from yak_communication.logging import print_warning, print_progress
...
class Schema(object):
    def __init__(self, schema_path):
        ...
        print_progress("Parsing your schema file")
    ...
    def validate_json(self, url_json):
        ...
        for attribute, value in url_json.iteritems():
            if attribute not in self.VALID_ATTRIBUTES:
                print_warning("Found unsupported attribute, {}, for url: {}".format(attribute, self.url_path))
