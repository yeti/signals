...
class MainTestCase(unittest.TestCase):
    def test_run_command(self):
        command = "python -m signals --schema ./tests/files/test_schema.json --generator ios " \
                  "--datamodels ./tests/files/ --projectname YetiProject --templates objc"
    ...
    def test_run_main(self):
        with captured_stderr() as error, captured_stdout() as out:
            run_main("./tests/files/test_schema.json", "ios", "objc", "./tests/files/", None, "YetiProject", False)
    ...
    def test_run_main_error(self, mock_subprocess):
        ...
        with captured_stdout() as out:
            run_main("./tests/files/test_schema.json", "ios", "objc", "./tests/files/", "./core/data/path",
                     "YetiProject", False)
