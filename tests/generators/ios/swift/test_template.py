...
from signals.parser.schema import Schema, URL, DataObject
...
class SwiftTemplateTestCase(unittest.TestCase):
    ...
    def test_methods_send_object_template(self):
        ...
        self.assertTemplateEqual('methods/send_object.j2', 'SendObjectWithId.swift', {
            'api': api
        })
        ...
        self.assertTemplateEqual('methods/send_object.j2', 'SendObject.swift', {
            'api': api
        })
    ...
    def test_api_method_template(self):
        ...
        self.assertTemplateEqual('api_method.j2', 'APIMethod.swift', {
            'api': api,
            'schema': schema,
            'VIDEO_FIELD': Field.VIDEO,
            'IMAGE_FIELD': Field.IMAGE,
